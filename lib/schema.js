 ...
 */
Object.defineProperty(Schema.prototype, 'tables', { get: helper.createOrderedObjectsGetter('table', {parent: '$this.fullCatalogName'}), enumerable: true });
 ...
 */
Object.defineProperty(Schema.prototype, 'tablesByName', { get: helper.createNamedObjectsGetter('table', {parent: '$this.fullCatalogName'}), enumerable: true });
 ...
 * ({@link Table}, index, collection). If no callback is provided, returns an array of all [tables]{@link Table}.
 * @method Schema#getTables
 * @param {orderedTableCallback} [callback] - Callback to be executed for each table.
 * @returns {Array.<Table>|undefined|null}
 * @example
 ...
 * );
 */
Object.defineProperty(Schema.prototype, 'getTables', { value: helper.createOrderedObjectsGetter('table', {parent: '$this.fullCatalogName'}), enumerable: false });
