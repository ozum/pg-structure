...
let attributes  = [['name', 'fullName'], ['description', 'comment'], ['parent', 'db'], 'tables', 'types'];
...
class Schema {
     ...
     * @param   {string}    args.description    - Description of the Schema.
    ...
    serialize() {
        ...
        result.types = Array.from(_.types).map(i => i[1].serialize());
        return result;
    }
}
 ...
 * @see Aliases {@link Schema#description description}
 */
 ...
 * @readonly
 * @description Comment of the schema.
 * @see Aliases {@link Schema#comment comment}
 */
 ...
 * @type {Map.<Type>}
 * @readonly
 * @description All {@link Type} instances of the schema as a {@link Map}. They are ordered by their name.
 * @see {@link Map}
 * @example
