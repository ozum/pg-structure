...
class Table {
     ...
     * @param   {string} args.kind              - Kind of table. (`table` or `view`)
    ...
    serialize() {
        ...
        let result = helper.serialize(_, ["name", "description", "descriptionData", "kind"]);
...
function getForeignKeyConstraints() {
    return Array.from(this.constraints)
        .filter(el => el[1].type === "FOREIGN KEY")
        .sort(helper.sortMapPairsByKey);
}
...
function getM2ORelations() {
    ...
    return new ASet(
        Array.from(this.foreignKeyConstraints.values()).map(
            c =>
                new M2O({
...
function getO2MRelations() {
    ...
    return new ASet(
        Array.from(this.foreignKeyConstraintsToThis.values()).map(
            c =>
                new O2M({
...
function* throughConstraints(onlyPk) {
    for (let fkToThis of this.foreignKeyConstraintsToThis.values()) {
        if (onlyPk && !Array.from(fkToThis.columns.values()).every(c => c.isPrimaryKey)) {
            // Skip if not all columns are PK
            continue;
        }
        ...
        for (let fkToOther of fkToThis.table.foreignKeyConstraints.values()) {
            ...
            if (onlyPk && !Array.from(fkToOther.columns.values()).every(c => c.isPrimaryKey)) {
                // Skip if not all columns are PK
                continue;
            }
...
function getM2MRelations(onlyPk) {
    ...
    for (let fkc of throughConstraints.call(this, onlyPk)) {
        ...
        for (let c of fkc.toOther.referencedTable.foreignKeyConstraints.values()) {
            ...
            if (c.referencedTable.name === this.name && c.table.name === fkc.toOther.referencedTable.name) {
                // tA -< tX >- tB  && tA -< tB
...
function getRelations() {
    return new ASet(
        Array.from(this.o2mRelations.values()).concat(
            Array.from(this.m2oRelations.values()),
            Array.from(this.m2mRelations.values())
        )
    );
}
 ...
 * @type {string}
 * @readonly
 * @description Kind of table. One of the values of `table` or `view`.
 */
 ...
 */
Object.defineProperty(Table.prototype, "foreignKeyConstraints", {
    get: helper.cachedValue({
        collectionClass: CMap,
        data: _data,
        cacheKey: "foreignKeyConstraints",
        calculatedFrom: "constraints",
        calculator: getForeignKeyConstraints
    }),
    enumerable: true
});
 ...
 */
Object.defineProperty(Table.prototype, "foreignKeyColumns", {
    get: helper.cachedValue({
        collectionClass: CMap,
        data: _data,
        cacheKey: "foreignKeyColumns",
        calculatedFrom: "foreignKeyConstraints",
        calculator: getForeignKeyColumns
    }),
    enumerable: true
});
...
Object.defineProperty(Table.prototype, "primaryKeyConstraint", {
    get: helper.cachedValue({
        data: _data,
        cacheKey: "primaryKeyConstraint",
        calculatedFrom: "constraints",
        calculator: getPrimaryKeyConstraint
    }),
    enumerable: true
});
 ...
 * }
 */
Object.defineProperty(Table.prototype, "hasManyTables", {
    get: helper.cachedValue({
        collectionClass: CMap,
        data: _data,
        cacheKey: "hasManyTables",
        calculatedFrom: "foreignKeyConstraintsToThis",
        calculator: getHasManyTables
    }),
    enumerable: true
});
 ...
 * }
 */
Object.defineProperty(Table.prototype, "belongsToTables", {
    get: helper.cachedValue({
        collectionClass: CMap,
        data: _data,
        cacheKey: "belongsToTables",
        calculatedFrom: "foreignKeyConstraints",
        calculator: getBelongsToTables
    }),
    enumerable: true
});
 ...
 */
Object.defineProperty(Table.prototype, "o2mRelations", {
    get: helper.cachedValue({
        collectionClass: CSet,
        data: _data,
        cacheKey: "o2mRelations",
        calculatedFrom: "foreignKeyConstraintsToThis",
        calculator: getO2MRelations
    }),
    enumerable: true
});
 ...
 */
Object.defineProperty(Table.prototype, "m2oRelations", {
    get: helper.cachedValue({
        collectionClass: CSet,
        data: _data,
        cacheKey: "m2oRelations",
        calculatedFrom: "foreignKeyConstraints",
        calculator: getM2ORelations
    }),
    enumerable: true
});
 ...
 */
Object.defineProperty(Table.prototype, "get", {
