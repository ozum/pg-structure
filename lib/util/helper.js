...
module.exports.createReferencedObjectGetter = function createReferencedObjectGetter(attributeName, collectionName, options) {
     ...
     * @returns {Object}   - Object from given collection with full catalog.
     * @example
    ...
    return function referencedObjectGetter() {
        ...
        return _.registry.getCollection(collectionName).by('fullCatalogName', fullCatalogName)[objectKey];
    };
};
...
module.exports.createObjectsGetter = function createObjectsGetter(collectionName, filter, options) {
    ...
    /**
     * @returns {Array.<Object>|Object.<String, Object>}   - Returns array of objects or key/value object.
     */
    return function objectsGetter() {
        let collection = getFilteredObjects.call(this, collectionName, filter);//.map((value) => { return value[objectKey]; });
        let result = {};
        ...
        if (options.nameKey) {
            ...
            if (options.objectKey) collection = collection.map((value) => value[options.objectKey]);
            result = collection;
        }
