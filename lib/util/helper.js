 ...
 * @private
 * @param {string} attribute - Name of the internal attribute to iterate
 * @param {filterCallback} [filterCallback] - Callback to filter results. If returns true, object will be added, if false object will be discarded
 * @returns {Function}
 */
 ...
 * @param {string} constructor - Constructor function reference to create class object from plain object.
 ...
 * @returns {Function}
 */
module.exports.getObject = function getObject(attributeByName, attributeByPosition) {
