 ...
 * @type {Table}
 * @readonly
 * @description Child {@link Table table} of this {@link Constraint contraint}.
 ...
 * @type {Table}
 * @readonly
 * @description {@link Table} which this {@link Constraint contraint} belongs to or defined in. <br>
 ...
 * @type {DB}
 * @readonly
 * @description {@link DB} this {@link Constraint contraint} belongs to.
 */
 ...
 * @type {Schema}
 * @readonly
 * @description {@link Schema} this {@link Constraint contraint} belongs to.
 */
 ...
 * @readonly
 * @description Update rule for foreign key {@link Constraint contraints}. One of `CASCADE`, `SET NULL`, `SET DEFAULT`, `RESTRICT`, `NO ACTION`
 * If this is not a foreign key {@link Constraint contraint} this is `null`.
 */
Object.defineProperty(Constraint.prototype, 'onUpdate', {
     ...
     */
    get: function() {
        let fkConstraint = internal.get(this).registry.getCollection('referentialConstraint').by('leftJoinConstraintFullCatalogName', this.fullCatalogName);
        return fkConstraint.leftJoinConstraintOnUpdate;
    }, enumerable: true });
...
Object.defineProperty(Constraint.prototype, 'onDelete', {
    ...
    get: function() {
        let fkConstraint = internal.get(this).registry.getCollection('referentialConstraint').by('leftJoinConstraintFullCatalogName', this.fullCatalogName);
        return fkConstraint.leftJoinConstraintOnDelete;
    }, enumerable: true });

/**
 * For foreign key constraints, returns referenced {@link Table table} by this {@link Constraint contraint}.
 ...
 * @type {Table|null}
 * @readonly
 * @description For foreign key {@link Constraint contraints} this is {@link Table} instance this {@link Constraint contraint} refers to.
 * If this is not a foreign key {@link Constraint contraint} this is `null`.
 ...
 * @readonly
 * @description For foreign key {@link Constraint contraints} this is {@link Table} instance this {@link Constraint contraint} refers to.
 * If this is not a foreign key {@link Constraint contraint} this is `null`. <br>
...
function getColumns(callback) {
    ...
    for (let i = 0; i < result.length; i++) callback(result[i], i, result);
}
 ...
 * @readonly
 * @description List of {@link Column columns} restricted by {@link Constraint contraint}, in order their ordinal position
 ...
 * @readonly
 * @description List of columns restricted by {@link Constraint contraint}, in order their ordinal position within the constraint key.
 * If {@link Constraint contraint} does not have any columns this is `null`.
 */
Object.defineProperty(Constraint.prototype, 'columnsByName', {
    ...
    get: function() {
        ...
        columns.forEach((column) => { result[column.name] = column; });
        return result;
    }, enumerable: true });
