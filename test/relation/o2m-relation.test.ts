...
import getDb, { getRelationNameDb, getReverseRelationNameDb, getOptimalNameDb, getReverseOptimalNameDb } from "../test-helper/get-db";
...
const getNames = (table: string): string[][] => [
  ...
  (optimalDb.get(table) as Table).o2mRelations.map((r) => r.name),
  (reverseOptimalDb.get(table) as Table).o2mRelations.map((r) => r.name),
];
...
describe("O2MRelation", () => {
  ...
  describe("Names", () => {
    it("should have shortest names for 'difficulty' table.", () => {
      ...
      const expectedOptimal = ["max_difficulty_main_games", "max_difficulty_other_games", "min_difficulty_popular_games"];
    ...
    it("should have shortest names for 'class' table.", () => {
      ...
      const expectedOptimal = ["registries"];
    ...
    it("should have shortest names for 'student' table.", () => {
      ...
      const expectedOptimal = ["receiver_student_messages", "registries", "sender_student_messages"];
    ...
    it("should have shortest names for 'option' table.", () => {
      ...
      const expectedOptimal = ["bike_options", "first_option_main_cars", "second_option_second_cars"];
    ...
    it("should have shortest names for 'color' table.", () => {
      ...
      const expectedOptimal = ["shirts", "shoes"];
    ...
    it("should have shortest names for 'product' table.", () => {
      ...
      const expectedOptimal = ["alternative_product_cart_line_items", "cancelled_items", "favorite_items", "main_product_cart_line_items"];
    ...
    it("should have shortest names for 'cart' table.", () => {
      ...
      const expectedOptimal = ["cancelled_items", "favorite_items", "first_cart_cart_line_items", "second_cart_cart_line_items"];
