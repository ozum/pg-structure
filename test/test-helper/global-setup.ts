...
module.exports = async () => {
  ...
  await pgTestUtil.createDatabase({ drop: true, name: "pg-structure-test-main", file: `${__dirname}/ddl/main.sql` });
  await pgTestUtil.createDatabase({ drop: true, name: "pg-structure-test-relation-names", file: `${__dirname}/ddl/relation-names.sql` });
