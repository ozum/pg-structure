...
INSERT INTO contact (id, created_at, updated_at, name, surname, email, birth_date, is_active, company_id, second_company_id, custom, custom_hstore) VALUES (4, '2014-11-05 00:57:33', '2014-11-05 00:57:33', 'Metin', 'Keser', 'metin@ozsoft.com', '0150-01-01', true, 2, NULL, '{"team":"FB", "city":"Istanbul"}', '"city"=>"''Istanbul''", "team"=>"''FB''"');
