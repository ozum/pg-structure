...
<head>
	<meta charset="utf-8">
	<title>DocStrap Mixin: documents/schema</title>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-17">line 17</a>
			</li>
		</ul>
	</dd>
...
<dd>
    ...
    <div class="description">
        <p>The default name of the scheman when you use anonymous schemas. You can define this at the prototype for classified
schemas. The can also</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-44">line 44</a>
			</li>
		</ul>
	</dd>
...
<dd>
    ...
    <div class="description">
        <p>The schema that defines the validation rules. This should probably be defined at the prototype for each
object or model classification. It can be an anonymous schema defined right here, or this can be
registered schema names to use, or just a single name</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-19">line 19</a>
			</li>
		</ul>
	</dd>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-29">line 29</a>
			</li>
		</ul>
	</dd>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-54">line 54</a>
			</li>
		</ul>
	</dd>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-165">line 165</a>
			</li>
		</ul>
	</dd>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-153">line 153</a>
			</li>
		</ul>
	</dd>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-141">line 141</a>
			</li>
		</ul>
	</dd>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-177">line 177</a>
			</li>
		</ul>
	</dd>
...
<dt>
    <h4 class="name" id="defaultDoc"><span class="type-signature"></span>defaultDoc<span class="signature">(schema)</span><span class="type-signature"> &rarr; {object}</span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Builds a default document based on the schema. What this does is create a document from schema and for each property
that has a default value or is required, the resultant object will contain that property. It is useful for extending
values from some source that may be incomplete, like options or some such.</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-239">line 239</a>
			</li>
		</ul>
	</dd>
...
<dt>
    <h4 class="name" id="extract"><span class="type-signature"></span>extract<span class="signature">(<span class="optional">schema</span>, <span class="optional">src</span>)</span><span class="type-signature"> &rarr; {object}</span></h4>
...
<dd>
    ...
    <div class="description">
        <p>This method will create a new object that contains only the fields and no methods or other artifacts. This is useful
for creating objects to pass over the wire or save in a table. This is not deeply copied, so changes made to the
extracted object will be represented in this class for reference objects.</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-214">line 214</a>
			</li>
		</ul>
	</dd>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-122">line 122</a>
			</li>
		</ul>
	</dd>
...
<dt>
    <h4 class="name" id="getSchema"><span class="type-signature"></span>getSchema<span class="signature">(<span class="optional">schemaName</span>)</span><span class="type-signature"> &rarr; {object}</span></h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-190">line 190</a>
			</li>
		</ul>
	</dd>
...
<dd>
    ...
    <div class="description">
        <p>Initialize the schema collection by registering the with the handler. You can call this at any time and as often as you like. It will be called once
by the constructor on any instance schemas</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-101">line 101</a>
			</li>
		</ul>
	</dd>
...
<dt>
    <h4 class="name" id="validate"><span class="type-signature"></span>validate<span class="signature">(<span class="optional">record</span>, schemaName, <span class="optional">options</span>)</span><span class="type-signature"> &rarr; {object}</span></h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="documents_schema.js.html">documents/schema.js</a>,
				 <a href="documents_schema.js.html#sunlight-1-line-62">line 62</a>
			</li>
		</ul>
	</dd>
