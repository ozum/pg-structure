...
<head>
	<meta charset="utf-8">
	<title>DocStrap Module: strings/format</title>
...
<div class="row">
	...
	<div class="col-md-8">
		...
		<div id="main">
    		<h1 class="page-title">Module: strings/format</h1>
...
<dt>
    <h4 class="name" id="module:strings/format"><span class="type-signature"></span>(require("strings/format"))<span class="signature">(format, args)</span><span class="type-signature"> &rarr; {string}</span></h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="strings_format.js.html">strings/format.js</a>,
				 <a href="strings_format.js.html#sunlight-1-line-24">line 24</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">string</span>
    ...
    <pre class="sunlight-highlight-javascript">var strings = require(&quot;papyrus/strings&quot;);
var s = strings.format(&quot;Hello {0}&quot;, &quot;Madame Vastra&quot;);
// s = &quot;Hello Madame Vastra&quot;</pre>
