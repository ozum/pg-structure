...
<head>
	<meta charset="utf-8">
	<title>DocStrap Mixin: mixins/signalable</title>
...
<div class="row">
	...
	<div class="col-md-8">
		...
		<div id="main">
    		<h1 class="page-title">Mixin: mixins/signalable</h1>
		...
		<ul class="dummy">
			<li>
				<a href="mixins_signalable.js.html">mixins/signalable.js</a>,
				 <a href="mixins_signalable.js.html#sunlight-1-line-153">line 153</a>
			</li>
		</ul>
	</dd>
...
<dt class="name" id="autoLoadSignals">
    <h4><span class="type-signature"></span>autoLoadSignals<span class="type-signature"> :boolean</span></h4>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="mixins_signalable.js.html">mixins/signalable.js</a>,
				 <a href="mixins_signalable.js.html#sunlight-1-line-230">line 230</a>
			</li>
		</ul>
	</dd>
...
<dt class="name" id="signals">
    <h4><span class="type-signature"></span>signals<span class="type-signature"> :hash|function</span></h4>
...
<dd>
    ...
    <div class="description">
        <p>A hash of signals to create automatically. Each definition consists of a name for the signal as the key
and then a hash of options (nullable) for each signal</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="mixins_signalable.js.html">mixins/signalable.js</a>,
				 <a href="mixins_signalable.js.html#sunlight-1-line-238">line 238</a>
			</li>
		</ul>
	</dd>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="mixins_signalable.js.html">mixins/signalable.js</a>,
				 <a href="mixins_signalable.js.html#sunlight-1-line-165">line 165</a>
			</li>
		</ul>
	</dd>
